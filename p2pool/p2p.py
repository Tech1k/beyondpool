...
class Node(object):
    ...
    def got_conn(self, conn):
        ...
        print '%s peer %s:%i established. beyondpool version: %i %r' % ('Incoming connection from' if conn.incoming else 'Outgoing connection to', conn.addr[0], conn.addr[1], conn.other_version, conn.other_sub_version)
